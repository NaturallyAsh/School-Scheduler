...
import com.example.ashleighwilson.schoolscheduler.utils.RecordUtil;
...
{
    private static final String TAG = RecordDialog.class.getSimpleName();
    ...
    private String mFileName = "My Record";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.activity_record_dialog, null);
        String strMessage = _strMessage == null ? "Press To Record" : _strMessage;
        _timerView = rootView.findViewById(R.id.text_timer);
        _timerView.setText(strMessage);
        _recordButton = rootView.findViewById(R.id.record_button);
        ...
        alertDialog.setPositiveButton(strPositiveButton, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                _clickListener.OnClickListener(mFileName, _AudioSavePathInDevice, mElapsedMillis);
            }
        });
        ...
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                if(STATE_BUTTON.equals("RECORD")) {
                    ...
                    _timerView.setText(RecordUtil.formatSeconds(recorderSecondsElapsed));
                } else if(STATE_BUTTON.equals("PLAY")){
                    playerSecondsElapsed++;
                    _timerView.setText(RecordUtil.formatSeconds(playerSecondsElapsed));
                }
            }
        });
    }
