        ...
        WeekView.EmptyViewLongPressListener
{
    ...
    private static final int ADD_TIME_TABLE = 1050;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.action_week, menu);
        return true;
    }
    ...
    public void addNewEvent()
    {
        ...
        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(WeekViewActivity.this, TimeTableEditor.class);
                startActivityForResult(intent, ADD_TIME_TABLE);
            }
        });
