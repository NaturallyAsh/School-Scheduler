...
{
    private static final String TAG = CalendarObjectListInputStream.class.getSimpleName();
    ...
    public CalendarObjectList<? extends AbstractCollection<? extends CalendarObject>, ? extends CalendarObject> readList() {
