...
public class WeekViewFragment extends Fragment implements WeekView.EventClickListener,
    ...
    public void addNewEvent()
    {
        ...
        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                fm.popBackStack("TimeEdit", android.support.v4.app.FragmentManager.POP_BACK_STACK_INCLUSIVE);
            }
        });
