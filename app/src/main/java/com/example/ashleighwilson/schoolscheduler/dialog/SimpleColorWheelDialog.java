...
public class SimpleColorWheelDialog extends CustomViewDialog<SimpleColorWheelDialog>
{
    ...
    private eltos.simpledialogfragment.color.ColorWheelView mColorWheelView;
    ...
    protected View onCreateContentView(Bundle savedInstanceState) {
        ...
        mColorWheelView.setOnColorChangeListener(new eltos.simpledialogfragment.color.ColorWheelView.OnColorChangeListener() {
            @Override
